...
describe('Special - shared target', () => {
  describe('when the same scope', () => {
    test('be the same', () => {
      ...
      container.bind({ bind: A, klass: TargetClass });
      container.bind({ bind: B, klass: TargetClass });
  ...
  describe('when binding Global -> Local', () => {
    ...
    test('throw', () => {
      ...
      container.bind({ bind: A, klass: TargetClass, scope: Scope.Global });
  ...
  describe('when binding Transient -> Local', () => {
    ...
    test('act as local', () => {
      ...
      container.bind({ bind: A, klass: TargetClass, scope: Scope.Transient });
      container.bind({ bind: B, klass: TargetClass, scope: Scope.Transient });
